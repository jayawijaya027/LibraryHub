                    ...
                    <form method="POST" action="{{ route('loans.update', $loan->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="returned" id="returned" class="form-select @error('returned') is-invalid @enderror">
                                <option value="0" {{ old('returned', $loan->returned) == '0' ? 'selected' : '' }}>Belum Dikembalikan</option>
                                <option value="1" {{ old('returned', $loan->returned) == '1' ? 'selected' : '' }}>Sudah Dikembalikan</option>
                            </select>
                            @error('returned')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
